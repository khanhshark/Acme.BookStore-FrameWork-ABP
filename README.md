...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 4c30f1a3-fe1b-4f08-b9f7-067c1cd7ec3f
```

> `4c30f1a3-fe1b-4f08-b9f7-067c1cd7ec3f` is the password of the certificate, you can change it to any password you want.
